        ...
        <div class="row flash_sell_slider">
            ...
            <div class="col-xl-3 col-sm-6 col-lg-4">
                ...
                <div class="wsus__product_item">
                    ...
                    <span class="wsus__minus">-{{ calculateDiscountParcent($product->price , $product->offer_price) }}%</span>
                    @endif
                    <a class="wsus__pro_link" href="{{ route('product-detaile',$product->slug) }}">
                    ...
                    <div class="wsus__product_details">
                        ...
                        <a class="wsus__pro_name" href="{{ route('product-detaile',$product->slug) }}">{{ $product->name }}</a>
                        @if(checkDiscount($product))
