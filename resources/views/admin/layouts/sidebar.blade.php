          ...
          <ul class="sidebar-menu">
            ...
            'admin.child-category.*'
             ...
             <li class="dropdown {{setActive([
              ...
              <ul class="dropdown-menu">
                <li class="{{setActive(['admin.profile.*']) }}"><a class="nav-link" href="{{ route('admin.flash-sale.index') }}">Flash Sale</a></li>
                ...
                <li class="{{setActive(['admin.profile.*']) }}"><a class="nav-link" href="{{ route('admin.profile') }}">Vendor Profile</a></li>
