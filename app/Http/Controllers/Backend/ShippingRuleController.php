...
class ShippingRuleController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $shipping->save();
        return redirect()->route('admin.shipping-rule.index')->with('success', 'Shipping Role Create Succesfully!!');
    }
    ...
    public function update(Request $request, string $id)
    {
        ...
        $shipping->status=$request->status;
        $shipping->save();
        return redirect()->route('admin.shipping-rule.index')->with('success', 'Shipping Role Updated Succesfully!!');
