...
class VendorProductVariantItemController extends Controller
{
    ...
    $variantItem->save();
     return redirect()->route('vendor.products-variant-item.index',['productId'=>$request->product_id,'variantId'=>$request->variant_id])->with('success', 'Variant Item Create Succesfully!!');
    ...
    $variantItem->status=$request->status;
    $variantItem->save();
     return redirect()->route('vendor.products-variant-item.index',['productId'=>$variantItem->productVariant->product_id,'variantId'=>$variantItem->product_variant_id])->with('success', 'Variant Item Update Succesfully!!');
