...
use App\Http\Controllers\Backend\ProductImageGallaryController;
...
Route::resource('slider', SliderContoller::class);
...
Route::resource('products-image-gallary', ProductImageGallaryController::class);

/* Product Variant Route */

Route::put('products-variant/change-status', [ProductVariantController::class, 'changeStatus'])->name('product-variant.change-status');
...
Route::put('change-approved-status', [SellerProductsController::class, 'changeApprovedStatus'])->name('change-approved-status');
...
Route::put('flash-sale/show-at-home/status-status', [FlashSaleController::class, 'changeShowAtHomeStatus'])->name('flash-sale.show-at-home.change-status');
...
Route::put('coupons/coupons-status', [CouponController::class, 'changeStatus'])->name('coupons-status');
